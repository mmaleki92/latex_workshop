...
\begin{document}
    ...
    %------------------------------------------------
    \include{01_getting_started}

    %------------------------------------------------
    % session 02: MATHEMATICAL TYPESETTING
    %------------------------------------------------
	\include{02_mathematics_typesetting}

	%------------------------------------------------
	% session 03: DOCUMENT STRUCTURE
	%------------------------------------------------

	\include{03_document_structure}

	%------------------------------------------------
	% session 04: ADVANCED TOPICS
	%------------------------------------------------
    \include{04_advanced_topics}
   	
   	%------------------------------------------------
    % session 05: ADVANCED Figures
    %------------------------------------------------
    
    \include{05_advanced_figures}
